var jq=jQuery;var bp_ajax_request=null;var newest_activities='';var activity_last_recorded=0;jq(document).ready(function(){if('-1'==window.location.search.indexOf('new')&&jq('div.forums').length)
